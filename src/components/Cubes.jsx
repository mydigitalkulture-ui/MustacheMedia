...
const Cubes = ({
  ...
  }, [fullScreen, onPointerMove, resetAll, onClick, onTouchMove, onTouchStart, onTouchEnd]);
  ...
  return (
    <div
      className={fullScreen ? 'absolute inset-0 z-0 w-full h-full overflow-hidden' : 'relative w-1/2 max-md:w-11/12 aspect-square'}
      style={wrapperStyle}
    >
